...
class VisionRotaryEmbeddingFast(nn.Module):
    ...
    def forward(self, t):
        ...
        t_part = t[:,:,self.num_prompts:,:]
        rotated_half = rotate_half(t_part)
        t_modified = t_part * self.freqs_cos + rotated_half * self.freqs_sin
        t = torch.cat([t[:,:,:self.num_prompts,:], t_modified], dim=2)
        return t
