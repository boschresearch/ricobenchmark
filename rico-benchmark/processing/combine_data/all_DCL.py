...
folders = {
    "nuImages": "nuImages/annotations.json",
    "FLIR": "flir/annotations.json",
    "FishEye8K": "fisheye8k/annotations_rgb.json",
    "VisDrone": "visdrone/annotations.json",
    "SHIFT": "shift/annotations.json",
    "Woodscape": "woodscape/annotations_day.json",
    "SJTU": "sjtu/annotations_fused.json",
    "Sim10k": "sim10k/annotations_day.json",
    "BDD100K": "bdd100k/annotations.json",
    "LOAF": "loaf/annotations_indoor.json",
    "DENSEgated": "dense/annotations_gated.json",
    "Synscapes": "synscapes/annotations_day.json",
    "TIMo": "timo/annotations_ir.json",
    "DENSEinclement": "dense/annotations_inclement.json",
    "DSEC": "dsec/annotations.json",
}
