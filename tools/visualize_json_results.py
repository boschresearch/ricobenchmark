...
def process_visualizations(input_path, conf_threshold, num_images, dataset_id_map, metadata, dataset_name, task_id):
...
def main():
    ...
    visualizations, dicts = process_visualizations(args.input, args.conf_threshold, args.num_images,
                                                   dataset_id_map, metadata, dataset_name, args.task_id)
